<template>
  <WlIcon :size="props.size" class="wl-trash-animated-icon">
    <svg viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
      <path class="lid" :style="lidStyles" d="M177.1 48H270.8C273.5 48 276 49.3 277.5 51.6L296.5 80H151.5L170.5 51.6C172 49.4 174.5 48 177.2 48H177.1ZM354.2 80L317.5 24.9C307.1 9.4 289.6 0 270.9 0H177.1C158.4 0 140.9 9.4 130.5 24.9L93.8 80H80.1H32H24C10.7 80 0 90.7 0 104C0 117.3 10.7 128 24 128H35.6H364.3H412.4H424C437.3 128 448 117.3 448 104C448 90.7 437.3 80 424 80H416H367.9H354.2ZM364.3 128H35.6H83.7H364.3Z" />
